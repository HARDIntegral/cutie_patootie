    ...
    html! {
        <div class="flex flex-col items-center justify-center min-h-screen text-center px-4 py-12">
            ...
            <h2 class="text-1xl font-bold text-pink-700 mb-8 text-center font-sans">
                {"Lay in bed, close your eyes, and imagine that I'm right there with you tucking you in and giving you a kiss goodnight. Maybe we even count some sheep together to help you fall asleep 🐑"}
            </h2>
