    ...
    html! {
        <div class="flex flex-col items-center justify-center min-h-screen text-center px-4 py-12">
            <h1 class="text-3xl font-bold text-pink-700 mb-10 text-center font-sans">
                {"If You Wanna Text Me, Whatcu Doin Over Here Shawtie? 😭"}
            </h1>
            ...
            <h2 class="text-1xl font-bold text-pink-700 mb-8 text-center font-sans">
                {"Bro pick that phone up, hop over to iMessage and send me whatever! I'll text you back as soon as I can 💌 Maybe if its connect 4 I might hesitate a little to gather my composure a lil first lol 😭"}
            </h2>
